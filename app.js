const icons = {
  paw: `<svg viewBox="0 0 48 48" fill="none" aria-hidden="true"><path d="M13.5 22c4 0 6-3.2 5-7s-4.2-7-7.4-6.1-4.5 5-2.8 8.4c1.2 2.6 3 4.7 5.2 4.7Zm21 0c-4 0-6-3.2-5-7s4.2-7 7.4-6.1 4.5 5 2.8 8.4c-1.2 2.6-3 4.7-5.2 4.7ZM23.8 17c3.3-.2 5.2-3.5 4.4-7.5S24.7 2.7 21.6 3.7s-4.1 5-2.5 8.6c1.1 2.7 2.8 4.8 4.7 4.7Zm.2 5c-8 0-14 7.1-13.1 13.2.8 5.4 6.4 7.4 13.1 5.4 6.7 2 12.3 0 13.1-5.4C38 29.1 32 22 24 22Z" fill="currentColor"/></svg>`,
...
const logo = `<span class="logo">${icons.paw}</span>`;
...
const topbar = (title = 'SPIRIT') => `<header class="topbar"><div class="brand">${logo}<span class="brand__name">${title}</span></div><button class="icon-btn" data-toast="Próximamente: centro de avisos" aria-label="Notificaciones">${icons.menu}</button></header>`;
